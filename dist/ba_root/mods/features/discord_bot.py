...
async def refresh_stats():
    ...
    while not client.is_closed():
        ...
        if "pb" in part:
            ...
            part = part.replace("", ("<:bs_googleplay:1074689865188392971>"))
            part = part.replace("", ("<:bs_local:1074689818157658192>"))
...
class BsDataThread(object):
    ...
    def refreshStats(self):
        ...
        for i in ba.internal.get_game_roster():
            try:
                liveplayers[i['account_id']] = {'name': i['players'][0]['name_full'], 'client_id': i['client_id'],
                                                'device_id': i['display_string']}
            except:
                liveplayers[i['account_id']] = {'name': "<in-lobby>", 'clientid': i['client_id'],
                                                'device_id': i['display_string']}
        try:
